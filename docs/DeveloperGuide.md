...
Association between Person, Job and Application classes with attributes of respective classes are represented with more details by the below UML Diagram:
