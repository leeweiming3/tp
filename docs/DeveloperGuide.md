...
**`Main`** (consisting of classes [`Main`](https://github.com/acekhoon/tp/blob/master/src/main/java/seedu/hirehub/Main.java) and [`MainApp`](https://github.com/se-edu/addressbook-level3/tree/master/src/main/java/seedu/address/MainApp.java)) is in charge of the app launch and shut down.
