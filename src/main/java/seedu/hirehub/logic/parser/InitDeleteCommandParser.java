 ...
 */
public class InitDeleteCommandParser implements Parser<NewDeletePersonCommand> {
     ...
     */
    public NewDeletePersonCommand parse(String args) throws ParseException {
        try {
            Index index = ParserUtil.parseIndex(args);
            return new NewDeletePersonCommand(index);
        } catch (ParseException pe) {
            throw new ParseException(
                String.format(MESSAGE_INVALID_COMMAND_FORMAT, NewDeletePersonCommand.MESSAGE_USAGE), pe);
        }
    }
