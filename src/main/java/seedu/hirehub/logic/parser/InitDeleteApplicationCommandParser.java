 ...
 */
public class InitDeleteApplicationCommandParser implements Parser<NewDeleteApplicationCommand> {
     ...
     */
    public NewDeleteApplicationCommand parse(String args) throws ParseException {
        try {
            Index index = ParserUtil.parseIndex(args);
            return new NewDeleteApplicationCommand(index);
